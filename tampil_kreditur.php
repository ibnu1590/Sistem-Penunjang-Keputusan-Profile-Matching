...
<div class="content-wrapper">
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Master Data Kreditur</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div><a href="input_kreditur.php" class="btn btn-info">Tambah Data</a></div>
                <br>
                <div class="table-responsive">
                    <table id="example1" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php $no=1; foreach($db->select('*','kreditur')->get() as $data): ?>
                            <tr>
                                <td><?= $data['NIK'];?></td>
                                <td><?= $data['nama']?></td>
                                ...
                                <td><?= $data['Jabatan']?></td>
                                <td>
                                    <a class="btn btn-warning" href="edit_kreditur.php?id=<?php echo $data[0]?>">Edit</a>
                                    <a class="btn btn-danger"  onclick="return confirm('Yakin Hapus?')" href="delete_kreditur.php?id=<?php echo $data[0]?>">Hapus</a>
                                </td>
                            </tr>
                            <?php $no++; endforeach; ?>
                        </tbody>
